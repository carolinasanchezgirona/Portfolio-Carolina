    ...
    <main className="editorial-site">
      ...
      <div className="editorial-wrap seo-layout">
        ...
        <aside className="seo-sidebar" aria-label="Información práctica">
          ...
          <div className="seo-card"><h3>Áreas relacionadas</h3><div className="seo-related"><a href="/evaluacion-neuropsicologica/">Evaluación neuropsicológica</a><a href="/ictus-y-dano-cerebral-adquirido/">Ictus y daño cerebral</a><a href="/conmocion-cerebral-y-tce-leve/">Conmoción cerebral y TCE leve</a><a href="/estimulacion-cognitiva/">Estimulación cognitiva</a>
              <a href="/cuando-acudir-a-un-neuropsicologo/">Cuándo acudir a un neuropsicólogo</a></div></div>
        </aside>
      </div>
