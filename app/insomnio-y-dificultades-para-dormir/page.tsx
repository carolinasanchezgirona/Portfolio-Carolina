    ...
    <main className="editorial-site">
      ...
      <div className="editorial-wrap seo-layout">
        ...
        <aside className="seo-sidebar" aria-label="Información práctica">
          ...
          <div className="seo-card"><h3>Áreas relacionadas</h3><div className="seo-related"><a href="/ansiedad/">Ansiedad</a><a href="/estres-y-sobrecarga/">Estrés y sobrecarga</a><a href="/rumiacion-y-pensamientos-repetitivos/">Rumiación</a><a href="/depresion/">Depresión y bajo estado de ánimo</a></div></div>
        </aside>
      </div>
