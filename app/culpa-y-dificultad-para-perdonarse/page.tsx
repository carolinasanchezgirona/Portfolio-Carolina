    ...
    <main className="editorial-site">
      ...
      <div className="editorial-wrap seo-layout">
        ...
        <aside className="seo-sidebar" aria-label="Información práctica">
          ...
          <div className="seo-card"><h3>Áreas relacionadas</h3><div className="seo-related"><a href="/rumiacion-y-pensamientos-repetitivos/">Rumiación</a><a href="/autoestima-y-autocritica/">Autoestima y autocrítica</a><a href="/duelo/">Duelo</a><a href="/rupturas-de-pareja/">Rupturas de pareja</a>
