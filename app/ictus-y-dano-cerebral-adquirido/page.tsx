    ...
    <main className="editorial-site">
      <header className="site-header">
        ...
        <nav className="nav" aria-label="Navegación principal"><a href="/neuropsicologia/">Neuropsicología</a>
              ...
              <a href="/rehabilitacion-neuropsicologica/">Rehabilitación neuropsicológica</a><a href="/evaluacion-neuropsicologica/">Evaluación</a><a className="nav-cta" href="/cita/">Pedir cita</a></nav>
      </header>
