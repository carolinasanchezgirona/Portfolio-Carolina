    ...
    <main className="editorial-site">
      ...
      <div className="editorial-wrap seo-layout">
        <article className="seo-copy">
          ...
          <section><h2>Relación con deterioro cognitivo leve y demencia</h2><p>Algunas personas presentan <a href="/deterioro-cognitivo-leve/">deterioro cognitivo leve</a>, con dificultades objetivables pero autonomía relativamente conservada. En otros casos, el impacto funcional es mayor y puede ser necesario estudiar una <a href="/demencias/">demencia</a>.</p><p>La enfermedad de Alzheimer es una causa frecuente de demencia, pero no la única. El diagnóstico médico requiere integrar información clínica, neurológica y, cuando está indicado, pruebas complementarias.</p></section>
        ...
        <aside className="seo-sidebar" aria-label="Información práctica">
          ...
          <div className="seo-card"><h3>Áreas relacionadas</h3><div className="seo-related"><a href="/problemas-de-memoria/">Problemas de memoria</a><a href="/deterioro-cognitivo-leve/">Deterioro cognitivo leve</a><a href="/demencias/">Demencias</a><a href="/familiares-y-cuidadores-de-personas-con-demencia/">Familiares y cuidadores</a></div></div>
        </aside>
      </div>
