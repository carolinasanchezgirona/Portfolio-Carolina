    ...
    <main className="editorial-site">
      ...
      <div className="editorial-wrap seo-layout">
        <article className="seo-copy">
          ...
          <section><h2>Ansiedad social, rechazo y autoestima</h2><p>La ansiedad social puede relacionarse con <a href="/miedo-al-rechazo-y-necesidad-de-aprobacion/">miedo al rechazo y necesidad de aprobación</a>, <a href="/autoestima-y-autocritica/">autoestima y autocrítica</a> y <a href="/rumiacion-y-pensamientos-repetitivos/">rumiación</a>. También forma parte del espectro de problemas de <a href="/ansiedad/">ansiedad</a>, aunque su foco principal sea la evaluación social.</p></section>
        ...
        <aside className="seo-sidebar" aria-label="Información práctica">
          ...
          <div className="seo-card"><h3>Áreas relacionadas</h3><div className="seo-related"><a href="/ansiedad/">Ansiedad</a><a href="/miedo-al-rechazo-y-necesidad-de-aprobacion/">Miedo al rechazo</a><a href="/autoestima-y-autocritica/">Autoestima</a><a href="/rumiacion-y-pensamientos-repetitivos/">Rumiación</a></div></div>
        </aside>
      </div>
