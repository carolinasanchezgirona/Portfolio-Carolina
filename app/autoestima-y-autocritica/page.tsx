    ...
    <main className="editorial-site">
      ...
      <div className="editorial-wrap seo-layout">
        <article className="seo-copy">
          ...
          <section>
            <h2>Culpa, autorreproche y dificultad para perdonarse</h2>
            <p>La culpa puede ser útil cuando orienta a reparar un daño concreto, pero puede convertirse en un problema cuando se mantiene como autorreproche global, se revisa el pasado de forma repetitiva o se utiliza un error como prueba de falta de valor personal. En terapia se diferencia responsabilidad de castigo y se trabaja una evaluación más proporcionada de lo ocurrido.</p>
          </section>

          <section>
            <h2>Miedo al rechazo y necesidad de aprobación</h2>
            <p>Cuando la seguridad personal depende demasiado de gustar, evitar el conflicto o recibir confirmación externa, puede resultar difícil expresar desacuerdo, poner límites o tolerar que otra persona se decepcione. El trabajo terapéutico busca ampliar autonomía, seguridad interpersonal y capacidad para actuar sin necesitar aprobación constante.</p>
          </section>
