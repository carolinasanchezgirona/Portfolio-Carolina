    ...
    <main className="editorial-site">
      ...
      <div className="editorial-wrap seo-layout">
        ...
        <aside className="seo-sidebar" aria-label="Información práctica">
          ...
          <div className="seo-card"><h3>Áreas relacionadas</h3><div className="seo-related"><a href="/autoestima-y-autocritica/">Autoestima y autocrítica</a><a href="/dependencia-emocional/">Dependencia emocional</a><a href="/limites-y-relaciones-dificiles/">Límites</a><a href="/ansiedad/">Ansiedad</a></div></div>
        </aside>
      </div>
