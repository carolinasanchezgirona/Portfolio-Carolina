    ...
    <main className="editorial-site">
      ...
      <div className="editorial-wrap seo-layout">
        ...
        <aside className="seo-sidebar" aria-label="Información práctica">
          ...
          <div className="seo-card"><h3>Áreas relacionadas</h3><div className="seo-related"><a href="/ictus-y-dano-cerebral-adquirido/">Daño cerebral adquirido</a><a href="/problemas-de-atencion-y-concentracion-en-adultos/">Atención y concentración</a><a href="/funciones-ejecutivas-y-planificacion-en-adultos/">Funciones ejecutivas</a><a href="/evaluacion-neuropsicologica/">Evaluación neuropsicológica</a>
              <a href="/rehabilitacion-neuropsicologica/">Rehabilitación neuropsicológica</a></div></div>
        </aside>
      </div>
