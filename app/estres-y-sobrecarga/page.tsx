    ...
    <main className="editorial-site">
      ...
      <div className="editorial-wrap seo-layout">
        <article className="seo-copy">
          ...
          <section>
            <h2>Burnout y agotamiento laboral</h2>
            <p>Cuando el desgaste está ligado al trabajo puede aparecer agotamiento sostenido, distancia emocional respecto a las tareas, sensación de baja eficacia y dificultad para recuperar energía fuera del horario laboral. El abordaje incluye revisar demandas, margen de control, apoyo, límites, sobreimplicación y posibilidades reales de cambio.</p>
          </section>

          <section>
            <h2>Dificultad para desconectar del trabajo</h2>
            <p>En algunas personas la jornada termina, pero la actividad mental continúa: revisar pendientes, anticipar problemas, sentir culpa al descansar o permanecer disponible constantemente. Trabajar este patrón implica recuperar límites claros entre trabajo y descanso y revisar las reglas internas que convierten la disponibilidad permanente en una obligación.</p>
          </section>
...
<a href="/depresion/">Depresión y bajo estado de ánimo</a></div></div>
        </aside>
      </div>
