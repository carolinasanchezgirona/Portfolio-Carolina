    ...
    <main className="editorial-site">
      ...
      <div className="editorial-wrap seo-layout">
        ...
        <aside className="seo-sidebar" aria-label="Información práctica">
          ...
          <div className="seo-card"><h3>Áreas relacionadas</h3><div className="seo-related"><a href="/ataques-de-panico/">Ataques de pánico</a><a href="/ansiedad-anticipatoria-y-preocupacion-excesiva/">Ansiedad anticipatoria</a><a href="/ansiedad/">Ansiedad</a><a href="/ansiedad-por-la-salud-e-hipocondria/">Ansiedad por la salud</a>
              <a href="/fobias-especificas/">Fobias específicas</a></div></div>
        </aside>
      </div>
