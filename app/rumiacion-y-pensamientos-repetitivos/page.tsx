    ...
    <main className="editorial-site">
      ...
      <div className="editorial-wrap seo-layout">
        <article className="seo-copy">
          ...
          <section>
            <h2>Indecisión y necesidad de certeza</h2>
            <p>Dar más vueltas no siempre aporta más información. Algunas decisiones se bloquean porque la persona intenta eliminar por completo la posibilidad de equivocarse antes de elegir. En esos casos se trabaja cómo distinguir análisis útil de rumiación, aceptar un grado inevitable de incertidumbre y tomar decisiones con información suficiente en lugar de esperar una seguridad absoluta.</p>
          </section>
