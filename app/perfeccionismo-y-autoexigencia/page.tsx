    ...
    <main className="editorial-site">
      ...
      <div className="editorial-wrap seo-layout">
        <article className="seo-copy">
          ...
          <section>
            <h2>Procrastinación y bloqueo</h2>
            <p>Posponer no siempre responde a falta de voluntad. A veces la tarea activa miedo al error, estándares demasiado altos, incertidumbre sobre por dónde empezar o evitación del malestar. Cuando el perfeccionismo está detrás del bloqueo, dividir la tarea, aceptar versiones suficientemente buenas y exponerse a empezar sin garantías puede ser más útil que esperar a sentirse preparado.</p>
          </section>
...
<a href="/ansiedad/">Ansiedad</a><a href="/limites-y-relaciones-dificiles/">Límites y relaciones difíciles</a><a href="/psicologia/">Psicología General Sanitaria</a></div></div>
        </aside>
      </div>
