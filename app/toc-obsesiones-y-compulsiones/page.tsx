    ...
    <main className="editorial-site">
      ...
      <div className="editorial-wrap seo-layout">
        <article className="seo-copy">
          ...
          <section><h2>TOC y pensamientos intrusivos no son exactamente lo mismo</h2><p>Los <a href="/pensamientos-intrusivos-y-miedo-a-perder-el-control/">pensamientos intrusivos</a> pueden aparecer en muchas personas sin que exista TOC. El diagnóstico requiere valorar la presencia de obsesiones y compulsiones, su intensidad, el tiempo que consumen y el grado de interferencia.</p><p>El TOC también puede relacionarse con <a href="/ansiedad/">ansiedad</a>, <a href="/rumiacion-y-pensamientos-repetitivos/">rumiación</a> y una fuerte necesidad de certeza, pero la evaluación clínica ayuda a diferenciar los procesos.</p></section>
        ...
        <aside className="seo-sidebar" aria-label="Información práctica">
          ...
          <div className="seo-card"><h3>Áreas relacionadas</h3><div className="seo-related"><a href="/pensamientos-intrusivos-y-miedo-a-perder-el-control/">Pensamientos intrusivos</a><a href="/ansiedad/">Ansiedad</a><a href="/rumiacion-y-pensamientos-repetitivos/">Rumiación</a><a href="/ansiedad-anticipatoria-y-preocupacion-excesiva/">Ansiedad anticipatoria</a></div></div>
        </aside>
      </div>
